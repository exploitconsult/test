...
class TimbreFiscal(models.Model):
    ...
    amount_discount = fields.Monetary("Remise",compute='total_discount')
    amount_before_discount = fields.Monetary("Montant H.T", compute='total_discount')
